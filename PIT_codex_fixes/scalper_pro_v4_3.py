...
def verify_fill(order_id, fallback_price=None, fallback_qty=0, strategy="Momentum Scalper V4.3"):
    """
    ...
    for attempt in range(3):
        ...
        data = api_post("orderstatus", {"orderid": order_id, "strategy": strategy}, timeout=5)
        if not data:
            continue
